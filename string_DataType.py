...
name_3 = name_1[1:3]
print("slice 1:3", name_3)
name_3 = name_1[1:]
print("slice 1:", name_3)

# String Length -  len()
print("length of name_1", len(name_1))


# Convert string to upper case  - upper()
print("name_1.upper() = ", name_1.upper())


# Convert string to lower case  - lower()
print("name_1.lower() = ",name_1.lower())

# Replace some the string in sentence replace()
print("name_1.replace", name_1.replace("World","Python"))
