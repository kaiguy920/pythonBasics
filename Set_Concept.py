...
print("name_set", name_set) #==> {1, 2, 3, 4, 'Python'} ==> organizes & prints each value once 
print("name_set type", type(name_set))
...
# Length af a set
print("length of set", len(name_set))
...
b={4,5,6,1,2,}
c=a.union(b)
print("joining two sets .union()  ==>", c)
